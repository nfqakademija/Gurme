...
class UnitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GurmeMainBundle:Unit')->findAll();
     ...
     *
     * @Route("/", name="db_create")
     * @Method("POST")
     * @Template("GurmeMainBundle:Unit:new.html.twig")
     */
    ...
    */
    private function createCreateForm(Unit $entity)
    {
        $form = $this->createForm(new UnitType(), $entity, array(
            'action' => $this->generateUrl('db_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GurmeMainBundle:Unit')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new UnitType(), $entity, array(
            'action' => $this->generateUrl('db_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="db_update")
     * @Method("PUT")
     * @Template("GurmeMainBundle:Unit:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('db_delete', array('id' => $id)))
            ->setMethod('DELETE')
