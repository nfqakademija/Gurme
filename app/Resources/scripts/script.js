...
//    var postData = "Ingredientas";
    $scope.ingredientCheck = function() {
        ...
        $http({
            url: document.location.href.substring(0,document.location.href.length - 5) + '/ingredientCheck',
            method: "POST",
...
//            $scope.ingredients = null;
    ...
    $scope.loadRecipes = function() {
        ...
        $http({
            url: document.location.href.substring(0,document.location.href.length - 5) + '/list',
            method: "POST",
